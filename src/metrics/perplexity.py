"""
Source: https://github.com/huggingface/datasets/blob/main/metrics/perplexity/perplexity.py
"""
...
class Perplexity:
    ...
    def compute(self, input_texts, batch_size: int = 16, add_start_token: bool = True):
